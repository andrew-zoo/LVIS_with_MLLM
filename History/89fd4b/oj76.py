...
# visualiser
# >>> 강제 로컬 Visualizer 바인딩 (충돌 방지) <<<
import os, importlib.util, inspect
VIS_PATH = os.path.join(os.path.dirname(__file__), '..', 'visualizer.py')
spec = importlib.util.spec_from_file_location("viz_local", os.path.abspath(VIS_PATH))
viz_local = importlib.util.module_from_spec(spec); spec.loader.exec_module(viz_local)
Visualizer = viz_local.Visualizer
print("Using Visualizer from:", inspect.getsourcefile(Visualizer))
print("Visualizer __init__ sig:", inspect.signature(Visualizer.__init__))
# <<< 끝 >>>
...
JSON_ANNO_PATH = "/home/jhp0720/.vscode-server/data/User/LVIS_with_MLLM/mmdetection/data/D3/d3_json"
...
def main():
    ...
    ## dod dataset setup
    IMG_ROOT = "/home/jhp0720/.vscode-server/data/User/LVIS_with_MLLM/mmdetection/data/D3/d3_images"
    PKL_ANNO_PATH = "/home/jhp0720/.vscode-server/data/User/LVIS_with_MLLM/mmdetection/data/D3/d3_pkl"
